...
func init() {
	...
	Registry["prestateTracer"] = newPrestateTracer
}
...
func newPrestateTracer(ctx *Context, cfg json.RawMessage) (TracerResult, error) {
...
func (t *prestateTracer) Result() interface{} {
	v, _ := t.GetResult()
	return v
}
