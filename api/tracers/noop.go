...
func init() {
	...
	Registry["noopTracer"] = newNoopTracer
}
...
func newNoopTracer(ctx *Context, _ json.RawMessage) (TracerResult, error) {
...
func (t *noopTracer) CaptureEnd(output []byte, gasUsed uint64, d time.Duration, err error) {
}
...
func (t *noopTracer) Result() interface{} {
	return nil
}