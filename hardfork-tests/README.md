...
The Osaka test is to be run on a master and a cardinal instance. To that end the `cardinal-osaka.py` file should be copied onto a server running the target service. Running the test against the master ensures the veracity of the testing logic. 
